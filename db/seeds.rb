question1 = Question.create!({body: "At what age did you have your first child?"})
question1.choices.create!({body: "<18yrs"}, {body: "18-20yrs"}, {body: "20-25yrs"}, {body: "25-30yrs"}, {body: "30+yrs"}, {body: "I have no children."})

question2 = Question.create!({body: "What is your gender?"})
question2.choices.create!({body: "Cis Male"}, {body: "Cis Female"}, {body: "Trans Male"}, {body: "Trans Female"}, {body: "Other"})
														
question3 = Question.create!({body: "For the majority of your childhood, did you grow up in a single-parent household?"})
...
question4 = Question.create!({body: "Are you familiar with the term \"Social Justice\"?"})
...
question8 = Question.create!({body: "Have you ever been paid to write code, either through a stipend or in industry?"})
